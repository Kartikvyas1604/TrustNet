...
export interface AmountCommitmentVerifierInterface extends Interface {
...
export interface AmountCommitmentVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): AmountCommitmentVerifier;
  waitForDeployment(): Promise<this>;

  interface: AmountCommitmentVerifierInterface;
